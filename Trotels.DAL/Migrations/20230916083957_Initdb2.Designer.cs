...
namespace Trotels.DAL.Migrations
{
    ...
    [Migration("20230916083957_Initdb2")]
            ...
            modelBuilder.Entity("Trotels.Entity.Concrete.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 16, 11, 39, 57, 615, DateTimeKind.Local).AddTicks(1662));
            ...
            modelBuilder.Entity("Trotels.Entity.Concrete.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 11, 39, 57, 615, DateTimeKind.Local).AddTicks(3355));
            ...
            modelBuilder.Entity("Trotels.Entity.Concrete.Guest", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 11, 39, 57, 615, DateTimeKind.Local).AddTicks(5573));
            ...
            modelBuilder.Entity("Trotels.Entity.Concrete.Hotel", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 11, 39, 57, 615, DateTimeKind.Local).AddTicks(7766));
            ...
            modelBuilder.Entity("Trotels.Entity.Concrete.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 11, 39, 57, 615, DateTimeKind.Local).AddTicks(9363));
