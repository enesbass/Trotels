...
namespace Trotels.DAL.Migrations
{
    ...
    [Migration("20230916084629_Initdb3")]
            ...
            modelBuilder.Entity("Trotels.Entity.Concrete.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 16, 11, 46, 29, 796, DateTimeKind.Local).AddTicks(7058));
            ...
            modelBuilder.Entity("Trotels.Entity.Concrete.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 11, 46, 29, 796, DateTimeKind.Local).AddTicks(8725));
            ...
            modelBuilder.Entity("Trotels.Entity.Concrete.Guest", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 11, 46, 29, 797, DateTimeKind.Local).AddTicks(1328));
            ...
            modelBuilder.Entity("Trotels.Entity.Concrete.Hotel", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 11, 46, 29, 797, DateTimeKind.Local).AddTicks(3687));
            ...
            modelBuilder.Entity("Trotels.Entity.Concrete.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 11, 46, 29, 797, DateTimeKind.Local).AddTicks(5426));
